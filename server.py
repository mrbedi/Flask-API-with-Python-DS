...
def create_blog_post(user_id):
	...
	if not user:
		jsonify({"message": "User does not exist"}), 400
...
def get_one_blog_post(blog_post_id):
	...
	#using random to make insertion in binary search tree as random to avoid forming an imabalanced tree 
...
def delete_last_10():
	...
	return jsonify({"message": "Success: Deleted last 10 posts"}), 200
